 ...
 function checkSetup(){
    ...
    const cfg =
        localStorage.getItem("7kaih_config");
...
document.getElementById("setup-school").value,

        teacher:

document.getElementById("setup-teacher").value,
...
document.getElementById("setup-semester").value,
